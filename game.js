...
var actorChars = {
  ...
  "=": Lava, "|": Lava, "v": Lava,
  "w": Jewel, //A jewel will be what the player needs to collect to pass each level
  "j": Booster, //When a player hits this, their speed will increase
};
...
var newWobble = 1, newDist = 0.02

Booster.prototype.act = function(step) {
  this.wobble += step * newWobble;
  var wobblePos = Math.sin(this.wobble) * newDist;
  this.pos = this.basePos.plus(new Vector(0,wobblePos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // if the player touches lava and the player restarts
  // Player loses
